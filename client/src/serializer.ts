...
export default {
  ...
  binaryEncode(message){
    ...
    Array.from(join_ref, char => view.setUint8(offset++, (char as String).charCodeAt(0)))
    Array.from(ref, char => view.setUint8(offset++, (char as String).charCodeAt(0)))
    Array.from(topic, char => view.setUint8(offset++, (char as String).charCodeAt(0)))
    Array.from(event, char => view.setUint8(offset++, (char as String).charCodeAt(0)))
